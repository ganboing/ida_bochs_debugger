...
extern const MIDL_SERVER_INFO RefPtrInterface_ServerInfo;

extern const RPC_DISPATCH_TABLE RefPtrInterface_v1_0_DispatchTable;

static const RPC_SERVER_INTERFACE RefPtrInterface___RpcServerInterface =
    {
    sizeof(RPC_SERVER_INTERFACE),
    {{0xba209999,0x0c6c,0x11d2,{0x97,0xcf,0x00,0xc0,0x4f,0x8e,0xea,0x45}},{1,0}},
    {{0x8A885D04,0x1CEB,0x11C9,{0x9F,0xE8,0x08,0x00,0x2B,0x10,0x48,0x60}},{2,0}},
    (RPC_DISPATCH_TABLE*)&RefPtrInterface_v1_0_DispatchTable,
    0,
    0,
    0,
    &RefPtrInterface_ServerInfo,
    0x04000000
    };
RPC_IF_HANDLE RefPtrInterface_v1_0_s_ifspec = (RPC_IF_HANDLE)& RefPtrInterface___RpcServerInterface;
...
static const MIDL_STUB_DESC RefPtrInterface_StubDesc = 
    {
    (void *)& RefPtrInterface___RpcServerInterface,
    MIDL_user_allocate,
    MIDL_user_free,
    0,
    0,
...
static const RPC_DISPATCH_FUNCTION RefPtrInterface_table[] =
    {
    NdrServerCall2,
    0
    };
static const RPC_DISPATCH_TABLE RefPtrInterface_v1_0_DispatchTable = 
    {
    1,
    (RPC_DISPATCH_FUNCTION*)RefPtrInterface_table
    };

static const SERVER_ROUTINE RefPtrInterface_ServerRoutineTable[] = 
    {
    (SERVER_ROUTINE)RemoteFn
    };

static const MIDL_SERVER_INFO RefPtrInterface_ServerInfo = 
    {
    &RefPtrInterface_StubDesc,
    RefPtrInterface_ServerRoutineTable,
    bochs_rpc__MIDL_ProcFormatString.Format,
    RefPtrInterface_FormatStringOffsetTable,
    0,
    0,
    0,
    0};
